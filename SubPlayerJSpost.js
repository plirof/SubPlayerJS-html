!window.jQuery && document.write(unescape('%3Cscript src="jquery-2.1.1.min.js"%3E%3C%2Fscript%3E%3Cscript src="jquery.ajax-cross-origin.min.js"%3E%3C%2Fscript%3E'));
//TEST POST of subtitle
//loads video
...
class SubPlayerJS {
    ...
    constructor(div, file) {
        ...
        if (!$("link[href='http://fonts.googleapis.com/icon?family=Material+Icons']").length) {
            ...
            loadjscssfile("inc/icon.css", "css");
        }
        if (!$("link[href='inc/SubPlayerJS.css']").length) {
            loadjscssfile("SubPlayerJS.css", "css");
        }
        if (!$("link[href='inc/materialize.min.css']").length) {
            loadjscssfile("materialize.min.css", "css");
        }
...
//+++++++++++++++++++++++++++++++++++++++++++++++
    getPOSTEDSubtitle(videoid) {
        var extension = this.subtitle.replace(/^.*\./, '');
       var data="1 \n00:00:00,000 --> 00:00:04,921\n XxxxxxxxxxxxxxxxxxxxxxΔΟΚΙΜΗSubtitledtrailers\n2 \n00:00:04,000 --> 01:00:04,921\n ZZZZZZZZZZZZZZZZZXxxxxxxxxxxxxxxxxxxxxxΔΟΚΙΜΗSubtitledtrailers       ";
    ...
    postSubtitle(subtitledata) {
        this.resetSubtitle();
        this.subtitle = subtitledata;

        
            this.getPOSTEDSubtitle(this.videoid);
